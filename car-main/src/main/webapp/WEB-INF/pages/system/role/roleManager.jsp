...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        tableIns=table.render({
            ...
            ,url:'${PATH}/role/loadAllRole' //数据接口
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${PATH}/role/loadAllRole?"+params
                page:{curr:1}
            })
        });
        ...
        table.on('tool(roleTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除【'+data.rolename+'】这个角色吗', function(index){
                    //向服务端发送删除指令
                    $.post("${PATH}/role/delRole",{roleid:data.roleid},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch(){
            ...
            layer.confirm('真的删除选中的这些角色吗', function(index){
                //向服务端发送删除指令
                $.post("${PATH}/role/deleteBatchRole",params,function(res){
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
        ...
        function openselectRoleMenu(data){
            ...
            mainIndex=layer.open({
                ...
                yes:function(index, layero){
                    ...
                    <%--alert(roleid);--%>
                    <%--alert(ids);--%>
                    <%--$.post("${PATH}/role/saveRoleMenu",{"roleid":roleid,"ids":ids.join()},function(obj){--%>
                    <%--    layer.msg(obj.msg);--%>
                    <%--})--%>
                    var roleid=data.roleid;
                    ...
                    //保存角色和菜单的关系
                    $.post("${PATH}/role/saveRoleMenu",params,function(obj){
                ...
                success:function(index){
                    ...
                    menuTree = dtree.render({
                        ...
                        checkbarData: "choose" ,
                        url: "${PATH}/role/initRoleMenuTreeJson?roleId="+data.roleid // 使用url加载（可与data加载同时存在）
                    });
                }
            });
        }
