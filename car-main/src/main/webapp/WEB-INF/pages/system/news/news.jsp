...
<div id="newsBar" style="display: none;">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="viewNews">查看</a>
</div>
<!-- 数据表格结束 -->
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'layedit','laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${PATH}/news/loadAllNews' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${PATH}/news/loadAllNews?" + params,
                page:{curr:1}
            })
        });
        //初始化查询时间
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.title + '】这个公告吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${PATH}/news/delNews", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些公告吗', function (index) {
                //向服务端发送删除指令
                $.post("${PATH}/news/deleteBatchNews", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
