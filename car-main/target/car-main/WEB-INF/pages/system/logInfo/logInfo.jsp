...
<form class="layui-form" method="post" id="searchFrm">
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">登录用户信息:</label>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="startTime" id="startTime" readonly="true"  autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="loginip" id="loginip" readonly="true"  autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline" id="selectAndResgest">
...
<div  id="newBar" style="display: none;">
...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
        ...
        tableIns=table.render({
            ...
            ,url:'${PATH}/logInfo/loadlogInfo' //数据接口
            ...
            ,cols: [[   //列表数据
                ...
                ,{field:'loginname', title:'登录用户信息',align:'center'}
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${PATH}/logInfo/loadlogInfo?"+params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(logInfoTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除【'+data.loginname+'】这个日志吗', function(index){
                    //向服务端发送删除指令
                    $.post("${PATH}/logInfo/dellogInfo",{roleid:data.roleid},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch(){
            ...
            layer.confirm('真的删除选中的这些日志吗', function(index){
                //向服务端发送删除指令
                $.post("${PATH}/logInfo/deleteBatchLogInfo",params,function(res){
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
